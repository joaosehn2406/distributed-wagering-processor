...
export function loadEnvironment(): Environment {
  ...
  const environment: Environment = {
    ...
    databaseUrl: required('DATABASE_URL', 'postgresql://wager:wager@localhost:55432/wagering'),
    sqsEndpoint: required('SQS_ENDPOINT', 'http://localhost:45666'),
    awsRegion: required('AWS_REGION', 'us-east-1'),
    wagerQueueUrl: required(
      'WAGER_QUEUE_URL',
      'http://localhost:45666/000000000000/wager-transactions.fifo',
    ),
    wagerDlqQueueUrl: required(
      'WAGER_DLQ_QUEUE_URL',
      'http://localhost:45666/000000000000/wager-transactions-dlq.fifo',
    ),
    walletEventsQueueUrl: required(
      'WALLET_EVENTS_QUEUE_URL',
      'http://localhost:45666/000000000000/wallet-events.fifo',
    ),
